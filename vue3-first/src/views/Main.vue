    ...
    <header class="bg-black py-5">
      <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
          <h1 class="display-4 fw-bolder">[ Make your BLANK! ]</h1>
          <p class="lead fw-normal text-white-50 mb-0">
            Custome your Quiz Set!
          </p>
        </div>
      </div>
      <div class="container">
        ...
        >
          ...
          >
            <span>퀴즈 만들기</span><span>Go to make QuizSet</span>
          </button>
        </router-link>
      </div>
    </header>
        ...
        >
          <div class="col mb-5">
            <div class="card h-100">
              <!-- Product image-->
              <router-link aria-current="page" :to="{ name: 'Play' }">
                <img
                  class="card-img-top"
